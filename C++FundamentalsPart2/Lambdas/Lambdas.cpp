...
int main()
{
	...
	// capturign by value explicitly [x, y]
	int x = 3;
	int y = 7;
	...
	// capturing by value and changing locally [=] mutable - also changing the param (int& r)
	x = 1;
	y = 1;
	...
	// capturing whole stack by reference (and a neater way to keep initialization these vector)
	v.clear();
	int i = 0;
